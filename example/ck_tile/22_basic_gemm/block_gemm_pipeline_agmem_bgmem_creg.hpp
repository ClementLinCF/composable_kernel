...
struct BlockGemmPipelineAGmemBGmemCReg
{
    ...
    {
        static_assert(
            ck::is_same_v<ADataType, remove_cvref_t<typename ADramBlockWindowTmp::DataType>> &&
                ck::is_same_v<BDataType, remove_cvref_t<typename BDramBlockWindowTmp::DataType>>,
            "wrong!");
        ...
        constexpr index_t a_lds_block_space_size_aligned =
            ck::math::integer_divide_ceil(sizeof(ADataType) * a_lds_block_desc.get_element_space_size(),
                                      16) * 16;

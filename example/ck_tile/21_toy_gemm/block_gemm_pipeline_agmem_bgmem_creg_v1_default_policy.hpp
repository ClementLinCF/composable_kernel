...
struct BlockGemmPipelineAGmemBGmemCRegV1DefaultPolicy
{
    ...
    __host__ __device__ static constexpr auto MakeALdsBlockDescriptor()
    {
        ...
        constexpr auto a_lds_block_desc_0 = ck_tile::make_naive_tensor_descriptor(
            ck_tile::make_tuple(ck_tile::number<kKPerBlock / 8>{}, ck_tile::number<kMPerBlock>{}, ck_tile::number<8>{}),
            ck_tile::make_tuple(ck_tile::number<(kMPerBlock + 1) * 8>{}, ck_tile::number<8>{}, ck_tile::number<1>{}),
            ck_tile::number<8>{},
            ck_tile::number<1>{});

        constexpr auto a_lds_block_desc = ck_tile::transform_tensor_descriptor(
            a_lds_block_desc_0,
            ck_tile::make_tuple(ck_tile::make_pass_through_transform(kMPerBlock),
                       ck_tile::make_merge_transform(ck_tile::make_tuple(kKPerBlock / 8, 8))),
    ...
    __host__ __device__ static constexpr auto MakeBLdsBlockDescriptor()
    {
        ...
        constexpr auto b_lds_block_desc_0 = ck_tile::make_naive_tensor_descriptor(
            ck_tile::make_tuple(ck_tile::number<kKPerBlock / 8>{}, ck_tile::number<kNPerBlock>{}, ck_tile::number<8>{}),
            ck_tile::make_tuple(ck_tile::number<(kNPerBlock + 1) * 8>{}, ck_tile::number<8>{}, ck_tile::number<1>{}),
            ck_tile::number<8>{},
            ck_tile::number<1>{});

        constexpr auto b_lds_block_desc = ck_tile::transform_tensor_descriptor(
            b_lds_block_desc_0,
            ck_tile::make_tuple(ck_tile::make_pass_through_transform(kNPerBlock),
                       ck_tile::make_merge_transform(ck_tile::make_tuple(kKPerBlock / 8, 8))),
            ck_tile::make_tuple(ck_tile::sequence<1>{}, ck_tile::sequence<0, 2>{}),
            ck_tile::make_tuple(ck_tile::sequence<0>{}, ck_tile::sequence<1>{}));
    ...
    {
        using BlockGemmPolicy = ck_tile::BlockGemmASmemBSmemCRegV1DefaultPolicy;
